...
hl.bind(mainMod .. " + O",                    hl.dsp.layout("consume_or_expel next"))
hl.bind(mainMod .. " + I",                    hl.dsp.layout("consume_or_expel prev"))
hl.bind(mainMod .. " + M",                    hl.dsp.layout("fit_into_view"))
hl.bind(mainMod .. " + SHIFT + M",            hl.dsp.layout("fit expand"))
...
hl.bind("ALT + Print",     hl.dsp.exec_cmd(noctCall .. "screenshot-fullscreen all"))
