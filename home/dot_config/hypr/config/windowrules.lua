...
hl.window_rule({ match = { class = "^(.*phototonic.*)$", title = ".*Phototonic$" }, min_size = { "max(monitor_w, monitor_h)*0.35", "min(monitor_w, monitor_h)*0.35" }, float = true })
hl.window_rule({ match = { class = "^(.*swayimg.*)$", title = "^Swayimg:.+$" }, min_size = { "max(monitor_w, monitor_h)*0.35", "min(monitor_w, monitor_h)*0.35" }, float = true })
